...
(function ($) {
  ...
  var loadMyCartEvent = function(userOptions){
    ...
    var $buttonbadge icon= $("." + options.classCartIcon);
    var $buttonbadge = $("." + options.classCartBadge);
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        '<div class="modal fade" id="' + idMessageModal + '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">' +
        ...
        '<table class="table table-hover table-responsive" id="' + idMessageTable + '"></table>' +
        '</div>' +
